...
STRINGS["docs.item.thesis.title"] = pair("Bacheloroppgave 2026", "Bachelor thesis 2026")
...
STRINGS["docs.item.bop.title"] = pair("BOP 2026", "BOP 2026")
STRINGS["docs.item.bop.desc"] = pair("Bacheloroppgave – prosjektbeskrivelse og plan", "Bachelor project – description and plan")
STRINGS["docs.item.contract.title"] = pair("Samarbeidskontrakt", "Collaboration agreement")
